...
public class Suits {
    ...
    public static final SuitTemplate MARK7_FEATURES =
            new SuitTemplate("Mark 7", 200, 9,
                    new ArrayList<>(
                            List.of(SuitFeatures.ABILITIES.LIMITED_FLIGHT,
                                    SuitFeatures.ABILITIES.FULL_FLIGHT,
                                    SuitFeatures.ABILITIES.SENTRY_MODE,
                                    SuitFeatures.ABILITIES.SHOOT_ENDER_SHOT,
                                    SuitFeatures.ABILITIES.TELEPORT)),
                    new ArrayList<>(
                            List.of(MobEffects.NIGHT_VISION,
                                    MobEffects.DAMAGE_BOOST,
                                    MobEffects.MOVEMENT_SPEED,
    ...
    public static final SuitTemplate MARK8_FEATURES =
            new SuitTemplate("Mark 8", 200, 9,
                    new ArrayList<>(
                            List.of(SuitFeatures.ABILITIES.LIMITED_FLIGHT,
                                    SuitFeatures.ABILITIES.FULL_FLIGHT,
                                    SuitFeatures.ABILITIES.SENTRY_MODE,
                                    SuitFeatures.ABILITIES.WITHER_PUNCH,
                                    SuitFeatures.ABILITIES.SHOOT_WITHER_SKULLS,
                                    SuitFeatures.ABILITIES.WITHER_RESISTANCE)),
                    new ArrayList<>(
                            List.of(MobEffects.NIGHT_VISION,
                                    MobEffects.DAMAGE_BOOST,
                                    MobEffects.MOVEMENT_SPEED,
