package phewitch.powersuits.Common.Blocks;
public class BlockManager {

    //<editor-fold desc="Paladium">

//    public static final RegistryObject<Block> PALADIUM_ORE = registerBlock("paladium_ore", () ->
//            new Block(BlockBehaviour.Properties.copy(Blocks.IRON_BLOCK).noOcclusion()), PowerSuits.CreativeTab);
//    public static final RegistryObject<Block> DEEPSLATE_PALADIUM_ORE = registerBlock("deepslate_paladium_ore", () ->
//            new Block(BlockBehaviour.Properties.copy(Blocks.IRON_BLOCK).noOcclusion()), PowerSuits.CreativeTab);
//
...
//            OreConfiguration.target(OreFeatures.DEEPSLATE_ORE_REPLACEABLES, DEEPSLATE_PALADIUM_ORE.get().defaultBlockState())
//    );
