...
public class SuitArmourLegs extends SuitArmourBase{
    public SuitArmourLegs(ArmorMaterial materialIn, Type type, Properties properties, SuitFeatures features) {
